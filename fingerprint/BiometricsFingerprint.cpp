 ...
 */
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.1-service.hanoip"
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint@2.1-service.hanoip"
...
fingerprint_device_t* getFingerprintDevice() {
    fingerprint_device_t *fp_device;
    std::string vendor_modules[] = { "fpc", "chipone" };
